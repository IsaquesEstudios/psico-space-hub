...
function AtendimentosIndex() {
  return (
    <>
      <section className="relative flex min-h-[460px] items-center overflow-hidden bg-deep px-5 py-20 text-deep-foreground lg:min-h-[560px] lg:px-10 lg:py-24">
        <img
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-deep from-[0%] via-deep/80 via-[52%] to-deep/15 to-[100%]" />
